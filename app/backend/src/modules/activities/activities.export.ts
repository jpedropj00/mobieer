...
export function activityPdf(res: Response, activity: any) {
  ...
  doc.font("Helvetica-Bold").fontSize(18).fillColor("#16181d").text("MOBIEER", { continued: true }).fillColor("#f59e0b").text("  Relatório de Atividade");
  ...
  doc.moveDown(2).font("Helvetica").fontSize(8).fillColor("#9ca3af").text(`Documento gerado em ${new Date().toLocaleString("pt-BR")} • MOBIEER — Gestão empresarial`, { align: "center" }); doc.end(); return res;
}
